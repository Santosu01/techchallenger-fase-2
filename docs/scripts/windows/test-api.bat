@echo off
REM ==========================================
REM TESTAR SERVIÇOS - ToggleMaster
REM ==========================================
...
echo ==========================================
echo Testar Servicos - ToggleMaster
echo ==========================================

REM Obter URL do Ingress
...
if not defined INGRESS_URL (
    echo ERRO: Nao foi possivel obter a URL do Ingress.
    echo Verifique se o ingress foi criado e possui endereco externo.
    pause
    exit /b 1
)

...
Se você tiver o Docker e o Docker Compose instalados, pode subir o banco e a aplicação com um único comando:
...
1.  **Suba os containers:**
    ...
    ```
    Este comando irá:
    *   Subir um container PostgreSQL e executar o `db/init.sql` automaticamente.
    *   Compilar a aplicação Go em um container multi-stage.
    *   Conectar a aplicação ao banco usando as variáveis de ambiente pré-configuradas no `docker-compose.yml`.
